...
class TestCreateProductViews:
    ...
    def test_product_correct_inputs(self,authenticated_admin_client, product_data,product_create_url):
        response = authenticated_admin_client.post(product_create_url, product_data, format='json')
